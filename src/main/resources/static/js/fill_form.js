  ...
  $("#aa").text("");       //remove
    ...
    $('#questionContainer').append(questionHtml);
	                    ...
	                    var questionHtml = `
        <div class="" data-questionId="${item.id}" answertype="${item.answertype}"  >
	                            <div class="row pl-2 pr-2">
	                                <div class="col-xl-1 col-lg-1 col-sm-2 col-xs-12 colmspadding">
	                                    <span class="question">Q : ${index + 1}</span>
	                                </div>
	                    ...
	                    var questionHtml = `
	                        <div class="card mb-2 queshadow" data-questionId="${item.id}">
	                            <div class="card-body">
	                                <div class="row pl-2 pr-2">
	                                    <div class="col-xl-1 col-lg-1 col-sm-2 col-xs-12 colmspadding">
	                                        <span class="question">Q : ${index + 1}</span>
    ...
    var questionHtml = `
        <div class="card mb-2 queshadow" data-questionid="${item.id}" answertype="7">
            <div class="card-body">
                <div class="row pl-2 pr-2">
                    <div class="col-xl-1 col-lg-1 col-sm-2 col-xs-12 colmspadding">
                        <span class="question">Q : ${index + 1}</span>
...
$("#fillf").hide();
    ...
    $("#questionContainer").children().each(function() {
        ...
        if (answerType == 2) {
            ...
            if (typeof answerValue === 'undefined' || answerValue === null) {
                allValid = false;
                toastr.error('Please select an option for all select questions.');
                return false; // Exit each loop
            }
