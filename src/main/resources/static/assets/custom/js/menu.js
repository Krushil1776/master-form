...
if (usertype == "admin") {
    ...
    document.write("<a href='Completedf'><i class='fa fa-check-circle' aria-hidden='true'></i>Completed Form</a>");
    document.write("</li>");
    ...
    document.write("<ul class='submenu'>");
    document.write("<li><a href='masterU' class='subpaddings'>Users</a></li>");
    document.write("</ul>");
    document.write("</li>");
