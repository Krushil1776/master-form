                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-sm-4">
                                        <a onclick="fid()" href="javascript:void(0)"
                    ...
                    <div class="card mb-0">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-sm-4">
                                    <a onclick="clearForm()" class="show_port_table btn btn-warning float-right btn-padding"><i
                                    ...
                                    <div class="form-body mb-0">
                                        <div class="row pl-3 pr-3">
                                            ...
                                            <div class="col-xl-3 col-lg-5 col-sm-4 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <input  onkeyup="this.value = this.value.replace(/[^a-zA-Z_\s-]/g, '');" maxlength="15" id="TitleText" type="text" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-sm-3 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <input maxlength="15" id="AliasName" type="text" class="form-control">
                                                </div>
                                            </div>
										...
										<div class="col-xl-2 col-lg-3 col-sm-4 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <select id="Modeleid" class="selectpicker" data-style="lineheight12 bg-transfer"
                                            ...
                                            <div class="col-xl-2 col-lg-3 col-sm-4 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <select id="Characteristic" class="selectpicker" data-style="lineheight12 bg-transfer"
                                                        data-live-search="true">
                                                        <option value="" selected="selected">Select</option>
                                            ...
                                            <div class="col-xl-2 col-lg-3 col-sm-4 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <select id="Sub-Characteristic" class="selectpicker" data-style="lineheight12 bg-transfer"
                                                        data-live-search="true">
                                                    <!--     <option value="" selected="selected">Select</option>
                                            ...
                                            <div class="col-xl-2 col-lg-3 col-sm-4 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <select id="Recurrencee" class="selectpicker" data-style="lineheight12 bg-transfer"
                                                        data-live-search="true">
                                                  <!--       <option value="" selected="selected">Select</option>
                                            ...
                                            <div class="col-xl-2 col-lg-2 col-sm-4 col-xs-12 colmspadding">
                                                <div class="form-group">
                                                    ...
                                                    <select id="StartMonth" class="selectpicker" data-style="lineheight12 bg-transfer"
                                                        data-live-search="true">
                                                     <!--    <option value="" selected="selected">Select</option>
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-sm-6 colmspadding">
                                                        <div class="form-group">
                                                            <label>Compliance Period <span
                                                                    class="text-danger">*</span></label>
                                                            <input  oninput="checkInput(this)" maxlength="2" id="CompliancePeriod" type="text" class="form-control"
          ...
          <div class="modal-body" style="background-color: #F3F3F3;">
                    <div class="detailsbg">
                        <div class="row pr-2 pl-2">
                            <div class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 colmspadding">
                                <p class="mb-1 font-weight-600"><span class="font-weight-700">Form Title:</span> <span id="aa"></span></p>
                    ...
                    <div class="card mb-2 queshadow" id="questionContainer">
...
<!--                     <div class="card mb-2 queshadow">
    ...
    <div id="qmodal" class="modal fade addformquestion" tabindex="-1"  >
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div  class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                ...
                <div class="modal-body">
                            ...
                            <div class="surveydesign">
                                <table class="table table-striped nowrap mb-0">
                                    <tbody id="formquestion_datatable">
                                        ...
                                        <tr>
                                            <td width="16%" class="border-0"><label class="mt-1 mb-0">Question Name<span class="text-danger ml-1">*</span></label></label></td>
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    <input id="QuestionName" type="text" class="form-control"
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0"><textarea id="QDescription" class="form-control textareasize"
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                <select id="AnswerType" class="selectpicker anstypecombo"
                    ...
                    <!--                                <option value="0">No Answer Required</option>
                                ...
                                <div class="multichoicedata" style="display: none;">
                                    <hr class="mb-2 mt-2">
                                    <table id="multichoicedataa" class="table table-striped nowrap mb-0 multichoicetable">
                                        <tbody>
                                            <tr>
                                                <td class="text-center border-0" width="5%">
                                                    <i class="fa fa-arrow-right"></i>
                                ...
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-sm-5 colmspadding">
                                        <div class="custom-control custom-checkbox displayblock">
                                            ...
                                            <label id="QuestionActive" class="custom-control-label font-weight-300 m-t-5"
                ...
                <div class="modal-footer">
                    <a class="btn btn-danger text-white btn-padding float-right ml-1" data-dismiss="modal"><i
                            class="fa fa-times mr-2"></i>Close</a>
                    <a id="SaveQ" class="btn btn-success text-white btn-padding float-right" ><i
                            class="fa fa-floppy-o mr-2"></i>Save</a>
                </div>
            </div>
        </div>
...
<!--<script scr="js/master_form.js"></script>-->
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.0.1/js/toastr.js"></script>
    ...
    <script>
        ...
        function checkInput(input) {
            ...
            if (num < 1 || num > 12) {
                input.value = ''; // Clear the input if it's outside the range
            }
        }
