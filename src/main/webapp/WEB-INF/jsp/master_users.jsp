                                    ...
                                    <div class="row">                        
                                        ...
                                        <div class="col-xl-2 col-lg-2 col-sm-4 col-xs-12 colmspadding">
                                            <div class="form-group mb-0">
                                                ...
                                                <select id="sau"class="selectpicker" data-style="lineheight12 bg-transfer" data-live-search="true">
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-sm-3 col-xs-12 mb-0 btntop colmspadding">
                                            <div class="form-group mb-0">
                                            <a onClick="Serchdata()" class="save_form_details btn btn-success text-white btn-padding" id="searchbtn"><i class="fa fa-search mr-2"></i>Search</a>
                                                
                                            <a onClick="reset()" class="show-details-table btn btn-danger text-white btn-padding ml-1"><i class="fa fa-refresh mr-2"></i>Reset</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row pl-2 pr-2 pt-1">
                                    <div class="col-xl-3 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <input onkeyup="this.value = this.value.replace(/[^a-zA-Z_\s-]/g, '');" maxlength=15 id="fn" type="text" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <input onkeyup="this.value = this.value.replace(/[^a-zA-Z_\s-]/g, '');" maxlength=15  id="ln" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row pl-2 pr-2">
                                    ...
                                    <div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <input onkeyup="this.value=this.value.replace(/[^0-9]/g, '')" maxlength=10 id="cn" type="text" class="form-control text-right">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <select id="mf" class="selectpicker" data-style="lineheight12 bg-transfer" data-live-search="true">
                                                <option value="" selected="selected">Select</option>
                                ...
                                <div class="row pl-2 pr-2">
                                    ...
                                    <div class="col-xl-2 col-lg-4 col-sm-4 col-xs-12 colmspadding">
                                        <div class="form-group">
                                            ...
                                            <select id=role class="selectpicker" data-style="lineheight12 bg-transfer" data-live-search="true">
                                                <option value="" selected="selected">Select</option>
                                                <option value="Admin">Admin</option>
                                                <option value="User">User</option>
                                            </select>
