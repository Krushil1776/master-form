...
<body class="background-image-body background1 square scrollbar-dusty-grass square thin">
    ...
    <div class="wrapper wrapper-top">
        <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-3 col-lg-3 col-sm-6 col-xs-12 colmspadding">
                                            <div class="form-group mb-0">
                                                ...
                                                <select id="selectForm" class="selectpicker" data-style="lineheight12 bg-transfer"
                                        ...
                                        <div class="col-xl-2 col-lg-3 col-sm-6 col-xs-12 mb-0 btntop colmspadding">
                                            <div class="form-group mb-0">
                                                <a class="save_form_details btn btn-success text-white btn-padding"
                                                    id="searchbtn"   onclick="sw()"><i class="fa fa-search mr-2"></i>Go</a>
            ...
            <div class="row showformfill" style="display: none;" id="fillf">
                <div class="col-xl-12 col-lg-12 col-sm-12 colmspadding">
                    <div class="card">
	                                        ...
	                                        <div class="card-body">
	                                            <div class="row pl-2 pr-2">
	                                                ...
	                                                <div class="col-xl-11 col-lg-11 col-sm-10 col-xs-12 colmspadding">
	                                                    ...
	                                                    <div class="form-group mb-0">
	                                                        <div class="row pl-2 pr-2">
	                                                            <div class="col-xl-4 col-lg-12 col-sm-12 col-xs-12 colmspadding">
	                                                        ...
	                                                        <div class="row pl-2 pr-2">
	                                                            <div class="col-xl-4 col-lg-12 col-sm-12 col-xs-12 colmspadding">
	                                                                <select class="selectpicker" multiple data-selected-text-format="count"
	                                                                    data-style="lineheight12 bg-transfer" data-actions-box="true">
	                                                                    <option value="1">Choice 1</option>
	                                                                    <option value="2">Choice 2</option>
	                                                                    <option value="3">Choice 3</option>
	                                                                    <option value="4">Choice 4</option>
	                                    ...
	                                    <div class="card mb-0 queshadow">
	                                        <div class="card-body">
	                                            <div class="row pl-2 pr-2 text-center">
	                                                <div class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 colmspadding">
	                                                    <a class="btn btn-success btn-padding mr-2"><i
	                                                        class="fa fa-floppy-o mr-2"></i>Submit</a>
	                                                    <a class="btn btn-success btn-padding mr-2"><i
	                                                            class="fa fa-print mr-2"></i>Print</a>
	                                                    <a class="btn btn-success btn-padding"><i
	                        ...
	                        <div class="card-body">
	                            <div class="row pr-3 pl-3">
	                                <div class="col-xl-4 col-lg-4 col-sm-4 colmspadding">
	                                   <p class="compact mb-0"><span class="font-weight-700">Client</span>
	                                      <span class="displayblock font-medium-2">Scarborough Computer Centre (SCC)</span>
	                                   </p>
	                                </div>
	                                
	                                <div class="col-xl-4 col-lg-4 col-sm-4 colmspadding">
	                                   <p class="compact mb-0"><span class="font-weight-700">Site</span>
	                                      <span class="displayblock font-medium-2">ON - London - 1680 Richmond Street North</span>
	                                   </p>
	                                </div>
	           
	                                <div class="col-xl-4 col-lg-4 col-sm-4 colmspadding">
	                                   <p class="compact mb-0"><span class="font-weight-700">Building</span>
	                                      <span class="displayblock font-medium-2 mt-1">Central Utility Building (CUB)</span>
	                                   </p>
	                                </div>
	                             </div>
	                        </div>
    ...
    <div class="form-group mb-2">
        <input type="hidden" id="uidd" value="${userId}" />
                ...
                <div class="modal-footer bg-white">
                    ...
                    <a onClick="saveAnswer()" class="btn btn-success float-right btn-padding mr-2" data-dismiss="modal"><i
